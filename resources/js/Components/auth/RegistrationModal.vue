    ...
    >
        <DialogContent class="sm:max-w-[425px]">
            <DialogHeader>
                ...
                <DialogDescription>
                    Provide details information to create an account.
                </DialogDescription>
            </DialogHeader>
            ...
            <DialogFooter class="flex items-center">
                ...
                <Button
                    ...
                    class="bg-indigo-600 text-white py-2 px-4 rounded-md hover:bg-indigo-700 transition font-semibold"
                >
                    <Loader2
